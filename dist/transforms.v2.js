...
var Mathematics = function(dom, data) {
  let needsCSS = false;
...
var Meta = function(dom, data) {
  ...
  function meta(name, content, force) {
    if (content || force)
      { appendHead(`    <meta name="${name}" content="${index(content)}" >\n`); }
  }
  ...
  if (data.publishedDate){
    ...
    <meta property="description"       itemprop="description"   content="${index(data.description)}" />
  ...
  (data.authors || []).forEach((a) => {
    appendHtml(head, `
    <meta property="article:author" content="${index(a.firstName)} ${index(a.lastName)}" />`);
  });
  ...
  appendHead(`
    ...
    <meta property="og:description" content="${index(data.description)}">
  ...
  appendHead(`
    ...
    <meta name="twitter:description" content="${index(data.description)}">
...
function citation_meta_content(ref){
  ...
  if ('journal' in ref){
    content += `citation_journal_title=${index(ref.journal)};`;
  }
  if ('volume' in ref) {
    content += `citation_volume=${index(ref.volume)};`;
  }
  if ('issue' in ref || 'number' in ref){
    content += `citation_number=${index(ref.issue || ref.number)};`;
  }
  return content;
}
...
var CitationList = function(dom, data) {
...
var DistillHeader = function(dom, data) {
...
var DistillAppendix = function(dom, data) {
